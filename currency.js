...
let apiKey = '2df004c981a7e2dfc11d4f4d'

// Все переменные
const dropList = document.querySelectorAll("form select");
const fromCurrency = document.querySelector(".from select");
const toCurrency = document.querySelector(".to select");
const getBtn = document.querySelector(".currency-btn");
...
const getExchangeRate = () => {
    if (!fromCurrency || !toCurrency || !amount || !exchangeRateText) {
        console.error("One or more elements are missing in DOM.");
        return;
    }
